...
export function getModuleOrder(): string[] { return getState().meta.settings.moduleOrder ?? []; }
export function setModuleOrder(order: string[]): string[] {
  getState().meta.settings.moduleOrder = order;
  savePlatform();
  return order;
}
